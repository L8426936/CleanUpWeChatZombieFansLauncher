...
### 控件文本改变
修改[text.json](https://github.com/L8426936/CleanUpWeChatZombieFans/blob/master/config/text_id/text.json)文件
```
{
...
| contacts | android.widget.TextView | ![](res/contacts.jpg) | 必需 | 必需 | 必需 | 必需 |  |
| delete | android.widget.TextView | ![](res/delete.jpg) | 非必需 | 必需 | 非必需 | 非必需 |  |
| close | android.widget.ViewGroup | 无法截图，暂时不贴图片了 | 必需 | 非必需 | 非必需 | 非必需 | 关闭转账弹窗，desc属性值 |
| return |  | 忘记是哪个低于哪个版本的微信用的了 | 必需 | 非必需 | 非必需 | 非必需 | 关闭转账弹窗，desc属性值 |
